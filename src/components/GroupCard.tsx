      ...
      <div className="flex items-center justify-between gap-6">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-slate-400">
            <span className="text-white font-medium">{group.contributionAmount} USDC</span> / month
          </p>
        </div>
        ...
        {/* Right Section */}
        <div>
          <button className="px-6 py-2.5 bg-emerald-500 hover:bg-emerald-600 text-white font-medium rounded-lg transition-colors duration-200 shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/30">
            Join
          </button>
        </div>
      </div>
